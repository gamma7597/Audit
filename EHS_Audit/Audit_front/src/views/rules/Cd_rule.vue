<template>
  <div>
    ...
    <form @submit.prevent="verifForm">
      ...
      <label v-if="groups.includes('GG-USR-APPCONFORMITE-ADMIN')" for="cd_rules_1_impact">
        <select
      ...
      <label v-if="groups.includes('GG-USR-APPCONFORMITE-ADMIN')" for="cd_rules_2_impact">
        <select
